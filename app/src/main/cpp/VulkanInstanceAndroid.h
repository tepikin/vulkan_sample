...
//    SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice device);
    ...
    void createGraphicsPipeline(AAssetManager *assetManager) {
        ...
        if (createShaderModule(assetManager, device, "shaders/triangle_vert.spv",
                               vertShaderModule.replace()) != VK_SUCCESS) {
            LOGE("failed to create vertex shader module!");
        }

        if (createShaderModule(assetManager, device, "shaders/triangle_frag.spv",
